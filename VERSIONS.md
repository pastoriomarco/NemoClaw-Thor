...
|---|---|---|
| **Qwen3.8 Thor SM110 overlay** | **verified working (2026-08-14)** | Profile-specific image `nemoclaw-thor/vllm-openai:qwen38-thor-sm110`: digest-pinned `vllm-openai:qwen38` preview, `v0.27.1` SM110 native extension, and official FlashInfer cubin 0.6.17. Verified with `unsloth/Qwen3.8-27B-NVFP4@9c73e2d`, vision, FP8 KV, and BF16 MTP K=3. This is intentionally separate from the default v9.1 image. Recipe: [`serving/docs/QWEN38-27B-NVFP4-THOR.md`](serving/docs/QWEN38-27B-NVFP4-THOR.md). |
