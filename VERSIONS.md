...
| OpenClaw (in-sandbox) | `v2026.5.22` | 2026-06-02 | Baked into NemoClaw `lkg` sandbox image (digest `sha256:b3d832b596…`). 2026.4.24 was the prior pin; the version bump triggered the [Jun-02 stack rebuild](manyforge/docs/REBUILD-2026-06-02-openshell-0.0.44.md). |
