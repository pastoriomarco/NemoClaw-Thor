...
| [`/home/tndlux/workspaces/dev_ws/src/manyforge/manyforge_composer/backend/routes_assistant.py`](https://github.com/pastoriomarco/manyforge/blob/main/manyforge_composer/backend/routes_assistant.py) | `execute_bridge_tool` validator path returns 200 + error envelope (was 4xx) |
